...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    insights_skill_activity: 'Skill Activity',
    insights_skill_total: 'Total',
    insights_skill_name: 'Skill',
    insights_skill_calls: 'Calls',
    insights_skill_active: 'Active',
    insights_skill_last_called: 'Last Called',
    insights_skill_changes: 'Changes',
    insights_skill_last_change: 'Last Change',
    insights_skill_no_activity: 'No skill activity in this period',
    insights_skill_summary: '{active} active skills · {changes} changes',
